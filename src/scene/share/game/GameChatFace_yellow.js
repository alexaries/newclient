 ...
 */
//选择表情
var GameChatFace_yellow = cc.Node.extend({
    mIndex:0, //某位置
    mFaceShows:[],//表情集合
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            tab02Item.setPosition(cc.p(-size_notice.width*0.5+2,65));
            ...
            for(var i=0;i<25;i++){
                ...
                item.setPosition(cc.p(-285+(i%7)*95,140-95*Math.floor(i/7)));
                item.setScale(0.95);
...
GameChatFace_yellow.create = function (gametype) {
    var sg = new GameChatFace_yellow();
    if (sg) {
