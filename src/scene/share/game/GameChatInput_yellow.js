 ...
 */
//选择表情
var GameChatInput_yellow = cc.Node.extend({
    mIndex:0, //某位置
    mFaceShows:[],//表情集合
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            tab03Item.setPosition(cc.p(-size_notice.width*0.5+2,-65));
            tab03Item.setScale(0.6);
            tab03Item.setEnabled(false);
            this.mTab3Item = tab03Item

            var sendsprite = cc.Sprite.create("#chat_btn_y.png");//ButtonSpriteWithWordInner("#g_btn_blue.png",sResWord.w_send,cc.p(0.5,0.5),24,0);
            var sendsprite1 = cc.Sprite.create("#chat_btn_y.png");//ButtonSpriteWithWordInner("#g_btn_blue.png",sResWord.w_send,cc.p(0.5,0.5),24,1);
            sendsprite1.setColor(cc.color(200,200,200))
            var sendsprite2 =  cc.Sprite.create("#chat_btn_y.png");//ButtonSpriteWithWordInner("#g_btn_blue.png",sResWord.w_send,cc.p(0.5,0.5),24,0);
...
GameChatInput_yellow.create = function (gametype) {
    var sg = new GameChatInput_yellow();
    if (sg) {
