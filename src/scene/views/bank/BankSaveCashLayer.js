...
var BankSaveCashLayer = BasePanelLayer.extend({  //BaseGameLayer  cc.Layer
    mPanelNode:null,
    mEditBox_cash:null,
    mSoftCashShow:null,
    mEbankCashShow:null,
    init:function () {
        ...
        if (this._super()) {
            ...
            sGameData.mBankSaveCashLayer = this;
            sGameData.mCurrLayer = this;

            log("BankSaveCashLayer start");
            ...
            var topsprite = ButtoSpritenWithSpriteInner("#p_top_tab_sel.png","#w_v_cunkuan.png",cc.p(0.65,0.5),0);
            ...
            var bottomsprite = ButtoSpritenWithSpriteInner("#p_bottom_tab.png","#w_v_qukuan.png",cc.p(0.65,0.5),0);
            ...
            var okItem = cc.MenuItemSprite.create(
                ...
                oksprite1,
                oksprite2,
                this.clickSaveCash,this);
            okItem.setAnchorPoint(cc.p(0.5,0.5));
            okItem.setPosition(cc.p(288,-80));
    ...
    onExit:function(){
        this._super();
        sGameData.mBankSaveCashLayer = null;
    ...
    showRightView:function(){
        ...
        //inputsprite1.setScale(0.5);
        //inputsprite1.setPosition(cc.p(160,-150));


        //var tipwordlabel = cc.LabelTTF.create(sResWord.w_bank_tip_word1, sGameData.mFontname, 20);
        //tipwordlabel.attr({
        //    x:160,
        //    y:-150
        //});
        //this.mPanelNode.addChild(tipwordlabel,10);
        //tipwordlabel.setColor(cc.color(60,60,60));
        ...
        aEditBox_cash.setPlaceHolder(sResWord.w_bank_tip_save_num);
    ...
    clickBottomTab:function(){
        ...
        playClickSound();
        gotoShowViewForBankGetCash();
    },
    clickSaveCash:function(){
        if(!checkButtonEnable()){
            return;
        }
        playClickSound();
        ...
        if(cashnum!=null&& cashnum.length > 0 && checkNumber(cashnum)) {
            ...
            if(!sGameData.mIsSendingData) {
                ...
                sGameData.mGameNet.sendEbankSaveCash(formatInputcash(cashnum));
            }
...
BankSaveCashLayer.create = function () {
    var sg = new BankSaveCashLayer();
    if (sg && sg.init()) {
        return sg;
    }
    return null;
